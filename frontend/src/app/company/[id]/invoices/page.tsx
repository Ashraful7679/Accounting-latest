    ...
    try {
      ...
      openPrintWindow(buildPrintDocument({ 
        ...
        signatures: {
          ...
          verifiedBy: invoice.verifiedBy ? `${invoice.verifiedBy.firstName} ${invoice.verifiedBy.lastName}` : undefined,
          approvedBy: invoice.approvedBy ? `${invoice.approvedBy.firstName} ${invoice.approvedBy.lastName}` : undefined
        }
      }));
    } catch {
