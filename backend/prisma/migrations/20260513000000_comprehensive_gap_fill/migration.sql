...
-- Ensure potentially-missing columns exist on tables that were manually created
-- (CREATE TABLE IF NOT EXISTS won't add missing columns to existing tables)
-- Add every FK-referenced column from new tables so FK constraints can succeed
ALTER TABLE "SalesOrder" ADD COLUMN IF NOT EXISTS "lcId" TEXT;
ALTER TABLE "SalesOrder" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "SalesOrder" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "SalesOrder" ADD COLUMN IF NOT EXISTS "deletedAt" TIMESTAMP(3);
ALTER TABLE "SalesOrderLine" ADD COLUMN IF NOT EXISTS "productId" TEXT;
ALTER TABLE "CreditNote" ADD COLUMN IF NOT EXISTS "salesOrderId" TEXT;
ALTER TABLE "CreditNote" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "CreditNote" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "CreditNote" ADD COLUMN IF NOT EXISTS "deletedAt" TIMESTAMP(3);
ALTER TABLE "DebitNote" ADD COLUMN IF NOT EXISTS "purchaseOrderId" TEXT;
ALTER TABLE "DebitNote" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "DebitNote" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "DebitNote" ADD COLUMN IF NOT EXISTS "deletedAt" TIMESTAMP(3);
ALTER TABLE "GRN" ADD COLUMN IF NOT EXISTS "purchaseOrderId" TEXT;
ALTER TABLE "GRN" ADD COLUMN IF NOT EXISTS "invoiceId" TEXT;
ALTER TABLE "GRN" ADD COLUMN IF NOT EXISTS "journalId" TEXT;
ALTER TABLE "GRN" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "GRN" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "DN" ADD COLUMN IF NOT EXISTS "salesOrderId" TEXT;
ALTER TABLE "DN" ADD COLUMN IF NOT EXISTS "invoiceId" TEXT;
ALTER TABLE "DN" ADD COLUMN IF NOT EXISTS "journalId" TEXT;
ALTER TABLE "DN" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "DN" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "PayrollPayslip" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "PayrollPayslip" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
ALTER TABLE "FixedAsset" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "FixedAsset" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3);
